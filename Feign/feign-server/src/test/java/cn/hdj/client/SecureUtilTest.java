...
public class SecureUtilTest {
    ...
    public void test_sign(){
        ...
        String signSrc = "request_encrypted=FE56ueVyNThFfPCkHw9yzyAdfNl+FIELi0F1FGs4gdIDtu7i9YKKvgD2qWKJQDZd4fQzCIOk+Ttsv3piINVjfggtu6tA0fvP5wxh7CIU67H6+VNHlEhQ15bgk8zkM3zz782kTU6RxilOSXC9tyWFAErNRPfjqTx4DUPenljLmp8=";

        String sign1 = SecurityUtil.sign(signSrc, privateKey);


        boolean verify = SecurityUtil.verify(signSrc, sign1, publicKey);
        Assert.isTrue(verify,"ok");
    }
}
